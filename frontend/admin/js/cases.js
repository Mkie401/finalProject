...
function renderCases(cases) {
    ...
    cases.forEach(casesNumber => {
        ...
        row.innerHTML = `
            <td><a href="/ReHome/frontend/content/home.html#pet-adoption-detail?casenumber=${casesNumber.id}" target="_blank" class="case-id-link">${casesNumber.id}</a></td>
...
async function approveCase(caseId) {
    ...
    try {
        ...
        casesLogger.error('同意案件失敗:', error);
