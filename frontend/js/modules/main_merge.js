...
function index_enableTouch(wrapper, track) {
...
function index_updatePosition(track, delta) {
...
function missing_startAutoScroll(track) {
...
function missing_stopAutoScroll() {
...
function missing_enableDrag(wrapper, track) {
    wrapper.addEventListener("mousedown", (e) => {
...
function missing_enableTouch(wrapper, track) {
    wrapper.addEventListener("touchstart", (e) => {
        missing_isDragging = true;
...
function missing_updatePosition(track, delta) {
