...
(function () {
    ...
    function initMap() {
        ...
        let startLat = (lostLocationLat && lostLocationLat.value) ? parseFloat(lostLocationLat.value) : DEFAULT_LAT;
        let startLng = (lostLocationLng && lostLocationLng.value) ? parseFloat(lostLocationLng.value) : DEFAULT_LNG;
