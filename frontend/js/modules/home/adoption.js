        ...
        if (result.success) {
            ...
            result.data.forEach(item => {
                ...
                const tagHtml = item.isPublic 
                    ...
                    : `<div class="private-Adoption">私有 <i class="bi bi-house"></i></div>`;
                ...
                htmlContent += `
                    <div class="index-card">
                        <a class="index_card_herf" href="#pet-adoption-detail?casenumber=${item.caseNumber}" target="_blank">
                            <div class="lost-pet-card">
                                ...
                                <div class="card-info">
                                    ...
                                    <p class="detail-item">體型: <span class="detail-value">${item.size || '未知'}</span></p>
